...
export const aboutContent = {
  ...
  subtitle: "Premium Spice Brand of Zafranix Global Private Limited.",
  image: "/images/about/1.png",
  description1:
    "Vibrant culinary centre of Delhi, Bharat Swaad was born from a singular obsession: to reclaim the purity of the Indian spice rack.",
  description2:
